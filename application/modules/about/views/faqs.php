...
<section class="cnt-breadcrumb-hero position-relative overflow-hidden">
    ...
    <div class="cnt-bc-ambient-bg" aria-hidden="true">
        ...
        <svg class="position-absolute w-100 h-100" style="top:0; left:0; pointer-events:none;" xmlns="http://www.w3.org/2000/svg">
            <defs>
                <pattern id="faqBcDotPattern" x="0" y="0" width="28" height="28" patternUnits="userSpaceOnUse">
                    <circle cx="2" cy="2" r="1.1" fill="#64748b" fill-opacity="0.16" />
                </pattern>
                <pattern id="faqBcGridPattern" width="100" height="100" patternUnits="userSpaceOnUse">
                    <path d="M 100 0 L 0 0 0 100" fill="none" stroke="#cbd5e1" stroke-width="0.75" stroke-opacity="0.3" stroke-dasharray="4 4" />
                </pattern>
                <linearGradient id="faqBcSweepRed" x1="0%" y1="0%" x2="100%" y2="0%">
                    <stop offset="0%" stop-color="#c91a25" stop-opacity="0.16" />
                    <stop offset="50%" stop-color="#f43f5e" stop-opacity="0.05" />
                    <stop offset="100%" stop-color="#ffffff" stop-opacity="0" />
                </linearGradient>
                <linearGradient id="faqBcSweepBlue" x1="100%" y1="0%" x2="0%" y2="100%">
                    <stop offset="0%" stop-color="#0284c7" stop-opacity="0.14" />
                    <stop offset="60%" stop-color="#38bdf8" stop-opacity="0.04" />
                    <stop offset="100%" stop-color="#ffffff" stop-opacity="0" />
                </linearGradient>
            </defs>
            <rect width="100%" height="100%" fill="url(#faqBcDotPattern)" />
            <rect width="100%" height="100%" fill="url(#faqBcGridPattern)" />
            <path d="M-50,65 C320,180 720,10 1200,110 C1600,200 1900,40 2200,80" fill="none" stroke="url(#faqBcSweepRed)" stroke-width="1.8" />
            <path d="M-20,130 C380,40 820,190 1300,60 C1700,-10 2000,120 2300,90" fill="none" stroke="url(#faqBcSweepBlue)" stroke-width="1.5" stroke-dasharray="6 6" />
            ...
            <div class="col-12 col-lg-8">
                ...
                <div class="cnt-bc-pill-wrap mb-3">
                    <?php $this->load->view('about/dynamic_breadcrumbs', [
                        ...
                        'bc_desc' => 'Find clear, comprehensive answers to common questions about our services, process, and support.',
                        'breadcrumbs' => [
                            ['name' => 'FAQs']
                        ]
                    ]); ?>
                ...
                <p class="cnt-bc-hero-desc">
                    Explore quick answers about our engagement workflows, pricing structure, project turnaround, and support standards.
                </p>
            </div>
            ...
            <div class="col-12 col-lg-4 d-flex justify-content-lg-end align-items-center">
                <div class="cnt-bc-hero-badges">
                    <div class="cnt-bc-badge">
                        ...
                        <span>Instant Searchable Answers</span>
                    </div>
                    <div class="cnt-bc-badge cnt-bc-badge-blue">
                        <i class="bi bi-patch-question-fill"></i>
                        <span>Verified Technical Guidelines</span>
                    </div>
                    <div class="cnt-bc-badge cnt-bc-badge-amber">
                        <i class="bi bi-chat-dots-fill"></i>
                        <span>Still Need Help? Live Chat Active</span>
                    </div>
                </div>
            </div>
