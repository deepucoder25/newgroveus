...
<section class="cnt-breadcrumb-hero position-relative overflow-hidden">
    ...
    <div class="cnt-bc-ambient-bg" aria-hidden="true">
        ...
        <svg class="position-absolute w-100 h-100" style="top:0; left:0; pointer-events:none;" xmlns="http://www.w3.org/2000/svg">
            <defs>
                <pattern id="tstBcDotPattern" x="0" y="0" width="28" height="28" patternUnits="userSpaceOnUse">
                    <circle cx="2" cy="2" r="1.1" fill="#64748b" fill-opacity="0.16" />
                </pattern>
                <pattern id="tstBcGridPattern" width="100" height="100" patternUnits="userSpaceOnUse">
                    <path d="M 100 0 L 0 0 0 100" fill="none" stroke="#cbd5e1" stroke-width="0.75" stroke-opacity="0.3" stroke-dasharray="4 4" />
                </pattern>
                <linearGradient id="tstBcSweepRed" x1="0%" y1="0%" x2="100%" y2="0%">
                    <stop offset="0%" stop-color="#c91a25" stop-opacity="0.16" />
                    <stop offset="50%" stop-color="#f43f5e" stop-opacity="0.05" />
                    <stop offset="100%" stop-color="#ffffff" stop-opacity="0" />
                </linearGradient>
                <linearGradient id="tstBcSweepBlue" x1="100%" y1="0%" x2="0%" y2="100%">
                    <stop offset="0%" stop-color="#0284c7" stop-opacity="0.14" />
                    <stop offset="60%" stop-color="#38bdf8" stop-opacity="0.04" />
                    <stop offset="100%" stop-color="#ffffff" stop-opacity="0" />
                </linearGradient>
            </defs>
            <rect width="100%" height="100%" fill="url(#tstBcDotPattern)" />
            <rect width="100%" height="100%" fill="url(#tstBcGridPattern)" />
            <path d="M-50,65 C320,180 720,10 1200,110 C1600,200 1900,40 2200,80" fill="none" stroke="url(#tstBcSweepRed)" stroke-width="1.8" />
            <path d="M-20,130 C380,40 820,190 1300,60 C1700,-10 2000,120 2300,90" fill="none" stroke="url(#tstBcSweepBlue)" stroke-width="1.5" stroke-dasharray="6 6" />
            ...
            <div class="col-12 col-lg-8">
                ...
                <div class="cnt-bc-pill-wrap mb-3">
                    <?php $this->load->view('about/dynamic_breadcrumbs', [
                        'bc_h1' => 'Customer Reviews & Testimonials',
                        'bc_desc' => 'Read verified reviews and feedback from enterprise clients who trust our solutions.',
                        'breadcrumbs' => [
                            ['name' => 'Testimonials']
                        ]
                    ]); ?>
                ...
                <h1 class="cnt-bc-hero-title mb-1">
                    Client Stories &amp; <span class="cnt-title-highlight">Testimonials</span>
                </h1>

                <!-- Short Concise Subtitle -->
                <p class="cnt-bc-hero-desc">
                    Read authentic reviews and firsthand experiences from startups, growing businesses, and enterprises we proudly serve.
                </p>
            </div>
            ...
            <div class="col-12 col-lg-4 d-flex justify-content-lg-end align-items-center">
                <div class="cnt-bc-hero-badges">
                    <div class="cnt-bc-badge">
                        ...
                        <span>4.9 / 5.0 Average Client Rating</span>
                    </div>
                    <div class="cnt-bc-badge cnt-bc-badge-blue">
                        <i class="bi bi-star-fill text-warning"></i>
                        <span>100% Genuine Verified Feedback</span>
                    </div>
                    <div class="cnt-bc-badge cnt-bc-badge-amber">
                        <i class="bi bi-hand-thumbs-up-fill"></i>
                        <span>98% Client Retention &amp; Referral</span>
                    </div>
                </div>
            </div>
