            ...
            <div class="col-12 col-lg-8">
                ...
                <div class="cnt-bc-pill-wrap mb-3">
                    <?php $this->load->view('about/dynamic_breadcrumbs', [
                        'bc_h1' => 'About Us - ' . (!empty($company3) ? $company3 : 'Our Company'),
                ...
                <h1 class="cnt-bc-hero-title mb-1">
                    About <span class="cnt-title-highlight"><?= !empty($company3) ? $company3 : 'Our Company' ?></span>
                </h1>

                <!-- Short Concise Subtitle -->
                <p class="cnt-bc-hero-desc">
                    Discover our journey, dedicated team of innovators &amp; engineers, core values, and commitment to client success.
                </p>
            </div>
            ...
            <div class="col-12 col-lg-4 d-flex justify-content-lg-end align-items-center">
                <div class="cnt-bc-hero-badges">
                    <div class="cnt-bc-badge">
                        ...
                        <span><?= !empty($experience) ? $experience : '12' ?>+ Years Industry Legacy</span>
                    </div>
