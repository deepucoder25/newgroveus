    ...
    <div class="container position-relative z-2">
        <div class="row align-items-center services-hero-row gy-5">
            ...
            <div class="col-12 col-lg-6 services-hero-left pe-lg-4">
                <div class="services-eyebrow mb-2" itemprop="headline">Our Services</div>
            ...
            <div class="col-12 col-lg-6 services-hero-right">
                <div class="services-mockup-wrapper">
                    <svg xmlns="http://www.w3.org/2000/svg"
                         viewBox="0 0 777 442"
                         fill="none"
                         class="services-hero-svg"
                         preserveAspectRatio="xMidYMid meet">

                      <defs>
                        <!-- Background -->
                        <linearGradient id="backgroundGrad"
                                        x1="0" y1="0"
                                        x2="777" y2="442"
                        ...
                        <radialGradient id="circleBgGrad"
                                        cx="40%" cy="44%" r="58%">
                      ...
                      <g clip-path="url(#screenClipPath)">
                        ...
                        <path d="
                          M450 250
                          C463 243 475 234 487 226
                          C496 219 502 207 511 201
                          C520 193 530 180 538 170
                          C544 165 550 165 557 170"
                          stroke="#E91B23"
                          stroke-width="7"
                      ...
                      <g filter="url(#cardShadowFilter)" class="svg-floating-card card-vis">
                        ...
                        <path d="
                          M155 125
                          C166 119 174 113 181 107
                          C186 102 190 96 196 89"
                          stroke="#111111"
                          stroke-width="3"
                          stroke-linecap="round"
                          fill="none"/>
                      ...
                      <g filter="url(#cardShadowFilter)" class="svg-floating-card card-traffic">
                        ...
                        <path d="
                          M648 116
                          C648 104 655 99 664 99
                          C672 99 679 104 679 116
                          Z"
                          fill="#DD2027"/>

                        <path d="
                          M673 115
                          C673 105 679 100 687 100
                          C695 100 701 105 701 115
                          Z"
                          fill="#E32A31"/>
...
<section class="services-catalog-section py-5 position-relative" id="servicesCatalog">
    <div class="container py-2 py-lg-4 position-relative z-2">
        ...
        <div class="row g-3 g-lg-4 services-grid-row" id="servicesGrid">
            ...
            <!-- Service 1: Local SEO -->
            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12 service-card-col" data-category="seo">
            ...
            <!-- Service 7: PPC & Paid Search Management -->
            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12 service-card-col" data-category="ppc">
                <div class="premium-service-card h-100">
                    <a href="<?= site_url('ppc-management-services') ?>" class="srv-card-link text-decoration-none d-flex flex-column h-100">
                        <div class="srv-card-thumb mb-3 position-relative overflow-hidden rounded-4">
                            <img src="<?= base_url('assets/images/services_modules/ppc_management.webp') ?>" alt="PPC Campaign Management" width="400" height="400" loading="lazy" class="img-fluid srv-thumb-img">
                        </div>
                        <div class="srv-card-info d-flex align-items-center justify-content-between mt-auto pt-2">
                            <div>
                                <span class="srv-cat-tag">PAID ADS &bull; ACQUISITION</span>
                                <h3 class="srv-card-title">PPC Campaign Management</h3>
                            </div>
                            <div class="srv-circle-btn">
                                <i class="bi bi-arrow-up-right"></i>
                            </div>
            ...
            <!-- Service 8: Web Design & Development -->
            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12 service-card-col" data-category="web">
                <div class="premium-service-card h-100">
                    <a href="<?= site_url('web-development-services') ?>" class="srv-card-link text-decoration-none d-flex flex-column h-100">
                        ...
                        <div class="srv-card-info d-flex align-items-center justify-content-between mt-auto pt-2">
                            <div>
                                <span class="srv-cat-tag">DESIGN &bull; WEB ENGINEERING</span>
            ...
            <!-- Service 9: Conversion Rate Optimization (CRO) -->
            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12 service-card-col" data-category="cro">
                <div class="premium-service-card h-100">
                    <a href="<?= site_url('cro-services') ?>" class="srv-card-link text-decoration-none d-flex flex-column h-100">
                        <div class="srv-card-thumb mb-3 position-relative overflow-hidden rounded-4">
                            <img src="<?= base_url('assets/images/services_modules/cro_services.webp') ?>" alt="Conversion Rate Optimization" width="400" height="400" loading="lazy" class="img-fluid srv-thumb-img">
                        </div>
                        <div class="srv-card-info d-flex align-items-center justify-content-between mt-auto pt-2">
                            <div>
                                <span class="srv-cat-tag">CRO &bull; CONVERSION SCIENCE</span>
                                <h3 class="srv-card-title">Conversion Optimization (CRO)</h3>
                            </div>
                            <div class="srv-circle-btn">
                                <i class="bi bi-arrow-up-right"></i>
                            </div>
            ...
            <!-- Service 10: Content Marketing -->
            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12 service-card-col" data-category="cro">
                <div class="premium-service-card h-100">
                    <a href="<?= site_url('content-marketing-services') ?>" class="srv-card-link text-decoration-none d-flex flex-column h-100">
                        <div class="srv-card-thumb mb-3 position-relative overflow-hidden rounded-4">
                            <img src="<?= base_url('assets/images/services_modules/content_marketing.webp') ?>" alt="Content Marketing Strategy" width="400" height="400" loading="lazy" class="img-fluid srv-thumb-img">
                        </div>
                        <div class="srv-card-info d-flex align-items-center justify-content-between mt-auto pt-2">
                            <div>
                                <span class="srv-cat-tag">GROWTH &bull; CONTENT STRATEGY</span>
                                <h3 class="srv-card-title">Content Marketing Strategy</h3>
                            </div>
                            <div class="srv-circle-btn">
                                <i class="bi bi-arrow-up-right"></i>
                            </div>
            ...
            <!-- Service 11: Email Marketing -->
            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12 service-card-col" data-category="cro">
                <div class="premium-service-card h-100">
                    <a href="<?= site_url('email-marketing-services') ?>" class="srv-card-link text-decoration-none d-flex flex-column h-100">
                        <div class="srv-card-thumb mb-3 position-relative overflow-hidden rounded-4">
                            <img src="<?= base_url('assets/images/services_modules/email_marketing.webp') ?>" alt="Email Automation & Drips" width="400" height="400" loading="lazy" class="img-fluid srv-thumb-img">
                        </div>
                        <div class="srv-card-info d-flex align-items-center justify-content-between mt-auto pt-2">
                            <div>
                                <span class="srv-cat-tag">RETENTION &bull; EMAIL AUTOMATION</span>
                                <h3 class="srv-card-title">Email Automation &amp; Drips</h3>
                            </div>
                            <div class="srv-circle-btn">
                                <i class="bi bi-arrow-up-right"></i>
                            </div>
            ...
            <!-- Service 12: Social Media Marketing -->
            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12 service-card-col" data-category="ppc">
                <div class="premium-service-card h-100">
                    <a href="<?= site_url('social-media-marketing') ?>" class="srv-card-link text-decoration-none d-flex flex-column h-100">
                        <div class="srv-card-thumb mb-3 position-relative overflow-hidden rounded-4">
                            <img src="<?= base_url('assets/images/services_modules/social_media.webp') ?>" alt="Social Media Growth" width="400" height="400" loading="lazy" class="img-fluid srv-thumb-img">
                        </div>
                        <div class="srv-card-info d-flex align-items-center justify-content-between mt-auto pt-2">
                            <div>
                                <span class="srv-cat-tag">SOCIAL &bull; BRAND GROWTH</span>
                                <h3 class="srv-card-title">Social Media Growth</h3>
                            </div>
                            <div class="srv-circle-btn">
                                <i class="bi bi-arrow-up-right"></i>
                            </div>
        ...
        <div class="row g-4 position-relative">
            ...
            <div class="col-lg-3 col-md-6 col-12">
                <div class="process-step-box p-4 rounded-4 bg-white h-100 position-relative">
                    <div class="step-badge-num mb-3">01</div>
                    <h4 class="step-title fw-bold mb-2">Deep Discovery Audit</h4>
            ...
            <div class="col-lg-3 col-md-6 col-12">
                <div class="process-step-box p-4 rounded-4 bg-white h-100 position-relative">
                    <div class="step-badge-num mb-3">02</div>
                    <h4 class="step-title fw-bold mb-2">Strategic Blueprint</h4>
                    <p class="step-desc text-muted small mb-0">
            ...
            <div class="col-lg-3 col-md-6 col-12">
                <div class="process-step-box p-4 rounded-4 bg-white h-100 position-relative">
                    <div class="step-badge-num mb-3">03</div>
                    <h4 class="step-title fw-bold mb-2">Agile Execution</h4>
                    <p class="step-desc text-muted small mb-0">
            ...
            <div class="col-lg-3 col-md-6 col-12">
                <div class="process-step-box p-4 rounded-4 bg-white h-100 position-relative">
                    <div class="step-badge-num mb-3">04</div>
                    <h4 class="step-title fw-bold mb-2">Scale &amp; Conversion</h4>
                    <p class="step-desc text-muted small mb-0">
